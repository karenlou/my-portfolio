    ...
    <main className="grid gap-20 grid-col-1 grid-rows-11 md:grid-cols-4 min-h-screen pt-[100px] md:pt-20 container mx-auto">
      ...
      <div className="relative row-span-10 md:col-span-3">
        <div className="md:flex md:justify-between md:items-center mb-4 animate-settle [--settle-delay:100ms]">
          ...
          <div className="align-text-bottom text-sm text-stone-500/70"><span className="text-sm text-stone-500">This site is still a work in progress.</span> Last updated Jan 24 2025.</div>
        </div>
